./populate_users_video.sh OnePiece575 0
./populate_users_video.sh OnePiece5752 0
...
sleep .1
./populate_users_video.sh TroubleMaker 2
sleep .1
./populate_users_video.sh OnePiece575 2
sleep .1
